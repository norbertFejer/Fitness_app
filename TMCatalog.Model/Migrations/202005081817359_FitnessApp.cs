namespace TMCatalog.Model.Migrations
{
    ...
    public partial class FitnessApp : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ClientMemberships", t => new { t.ClientMembership_ClientId, t.ClientMembership_TicketId })
                .Index(t => new { t.ClientMembership_ClientId, t.ClientMembership_TicketId });
